...
* Выгодно вести несколько проектов и получать с них комиссию как техлид/проджект
* Insurance policy \(company covers 50% of the lay-up risk\)
* Есть команда которая друг друга выручает
* Страховка
{% endhint %}
...
### 🧪 Create Positive Innovation by Max
